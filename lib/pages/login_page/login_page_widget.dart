...
class LoginPageWidget extends StatefulWidget {
  const LoginPageWidget({
    super.key,
    bool? isSwitchOn,
  }) : this.isSwitchOn = isSwitchOn ?? true;
...
class _LoginPageWidgetState extends State<LoginPageWidget> {
  ...
  void initState() {
    ...
    _model.switchValue = _model.acceptedPolicy;
  }
                                ...
                                Form(
                                  ...
                                  child: Stack(
                                    children: [
                                      ...
                                      Align(
                                        alignment:
                                            AlignmentDirectional(-0.79, -0.23),
                                        child: Text(
                                          'Password',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                      ...
                                      Align(
                                        alignment:
                                            AlignmentDirectional(-0.65, 0.42),
                                        child: Text(
                                      ...
                                      Align(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: !_model.acceptedPolicy
                                              ? null
                                              : () async {
                                                  if (_model.formKey
                                                              .currentState ==
                                        ...
                                        child: Padding(
                                          ...
                                          child: Switch.adaptive(
                                            ...
                                            onChanged: (newValue) async {
                                              ...
                                              if (newValue) {
                                                _model.acceptedPolicy =
                                                    !_model.acceptedPolicy;
                                                safeSetState(() {});
                                              }
                                            },
                                            activeColor: Colors.white,
                                            activeTrackColor: Color(0xFF3380EF),
