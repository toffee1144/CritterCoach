...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    critterCareAuthUserSubject.add(
      CritterCareAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<CritterCareAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  CritterCareAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = CritterCareAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    critterCareAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
CritterCareAuthUser? currentUser;
