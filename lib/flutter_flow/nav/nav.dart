...
class AppStateNotifier extends ChangeNotifier {
  ...
  CritterCareAuthUser? initialUser;
  CritterCareAuthUser? user;
  ...
  void update(CritterCareAuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: PlannerPageWidget.routeName,
          path: PlannerPageWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(
        ...
        FFRoute(
          name: StudySquadPageWidget.routeName,
          path: StudySquadPageWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'StudySquadPage')
              : StudySquadPageWidget(),
        ),
        FFRoute(
